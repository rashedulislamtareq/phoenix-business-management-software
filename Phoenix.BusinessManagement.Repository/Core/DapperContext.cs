...
namespace Phoenix.BusinessManagement.Repository.Core
{
    public class DapperContext : IDapperContext
    {
        ...
        {
            using IDbConnection db = new SqlConnection(_config.GetConnectionString(Connectionstring));
            List<dynamic> result = (await db.QueryAsync(sp, parms, commandType: commandType)).ToList();
            return result;
            //return (Task<IEnumerable<dynamic>>)db.Query(sp, parms, commandType: commandType).AsEnumerable();
        }
